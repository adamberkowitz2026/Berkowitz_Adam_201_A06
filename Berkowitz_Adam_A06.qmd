...
print(paste0("The maximum median annual temperature of ", which.max(median_temp), " occurred in ", max_temps$year[], " and the minimum median annual temperature of ". {}, " occurred in ", {}, "."))
```
